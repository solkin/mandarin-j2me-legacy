...
public class SettingsFrame extends Window {
  ...
  public final void initPanes() {
    ...
    keyValues = new int[ 29 ];
    keysCaption = new String[ 29 ];
    keysCaption[0] = "KEY_LOCKSCREEN";
    keysCaption[1] = "KEY_CLIENTINFO";
    keysCaption[2] = "KEY_BUDDYINFO";
    keysCaption[3] = "KEY_DIALOG";
    keysCaption[4] = "KEY_STATUSES";
    keysCaption[5] = "KEY_REMOVE";
    keysCaption[6] = "KEY_SENDFILE";
    keysCaption[7] = "KEY_SENDPHOTO";
    keysCaption[8] = "KEY_RENAME";
    keysCaption[9] = "KEY_SOUNDS";
    keysCaption[10] = "KEY_FILTERGROUPS";
    keysCaption[11] = "KEY_FILTEROFFLINE";
    keysCaption[12] = "KEY_SERVMESSAGES";
    keysCaption[13] = "KEY_LEFTACCOUNT";
    keysCaption[14] = "KEY_RIGHTACCOUNT";
    keysCaption[15] = "KEY_MINIMIZE";
    keysCaption[16] = "KEY_WRITE";
    keysCaption[17] = "KEY_COPY";
    keysCaption[18] = "KEY_PASTE";
    keysCaption[19] = "KEY_APPEND";
    keysCaption[20] = "KEY_CLEARCHAT";
    keysCaption[21] = "KEY_CLOSECHAT";
    keysCaption[22] = "KEY_BUDDYLIST_TOP";
    keysCaption[23] = "KEY_BUDDYLIST_BOTTOM";
    keysCaption[24] = "KEY_BUDDYLIST_SCREEN_HIGHER";
    keysCaption[25] = "KEY_BUDDYLIST_SCREEN_LOWER";
    keysCaption[26] = "KEY_REPLY";
    keysCaption[27] = "KEY_CHAT_SCREEN_TOP";
    keysCaption[28] = "KEY_CHAT_SCREEN_BOTTOM";
